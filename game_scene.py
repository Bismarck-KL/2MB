    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_1 or event.key == pygame.K_b:
                ...
                self.player_1.set_pose('ready')
            elif event.key == pygame.K_3 or event.key == pygame.K_p:
                self.player_1.trigger_action('punch', 0.5)
            elif event.key == pygame.K_4 or event.key == pygame.K_k:
                self.player_1.trigger_action('kick', 0.5)
                ...
                self.player_1.trigger_action('hurt', 0.5)

            # Player 2 控制 (小鍵盤或其他按鍵)
            elif event.key == pygame.K_KP7 or event.key == pygame.K_u:
                self.player_2.trigger_action('block', 0.5)
            elif event.key == pygame.K_KP8 or event.key == pygame.K_i:
                self.player_2.set_pose('ready')
            elif event.key == pygame.K_KP9 or event.key == pygame.K_o:
                self.player_2.trigger_action('punch', 0.5)
            elif event.key == pygame.K_KP4 or event.key == pygame.K_l:
                self.player_2.trigger_action('kick', 0.5)
            elif event.key == pygame.K_KP5 or event.key == pygame.K_RSHIFT:
                self.player_2.trigger_action('jump', 0.5)
            elif event.key == pygame.K_KP6 or event.key == pygame.K_SEMICOLON:
                self.player_2.trigger_action('hurt', 0.5)
