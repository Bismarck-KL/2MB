...
def pixelate_advanced(input_path, output_path, pixel_size=8, num_colors=16,
                      add_outline_effect=True, dither=False, outline_thickness=1):
    """
    ...
    Args:
        ...
        outline_thickness: Outline line thickness (1=thin, 2=thick)
    """
    ...
    if add_outline_effect:
        print(f"Adding outline (thickness: {outline_thickness})...")
        pixelated = add_outline(pixelated, thickness=outline_thickness)
    ...
    print(
        f"  Outline: {'Yes (thickness: ' + str(outline_thickness) + ')' if add_outline_effect else 'No'}")
